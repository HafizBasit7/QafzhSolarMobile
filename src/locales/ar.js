export default {
  ...
  AUTH: {
    ...
    "PASSWORD_REQUIREMENTS": "يجب أن تحتوي كلمة المرور على حرف كبير، رقم، ورمز خاص",
  ...
  "calculator": {
    ...
    "calculate": "حساب",
    "results": "النتائج",
    "totalDailyEnergy": "إجمالي الطاقة اليومية",
    "peakLoad": "أقصى حمل",
    "solarPanels": "الألواح الشمسية",
    "total": "الإجمالي",
    "batterySize": "حجم البطارية",
    "batteryDetails": "(بطارية 12 فولت، تفريغ 50٪)",
    "inverterSize": "حجم المحول",
    "appliances": {
      "light": "إضاءة",
      "fan": "مروحة",
      "refrigerator": "ثلاجة",
